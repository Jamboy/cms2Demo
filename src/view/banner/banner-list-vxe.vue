 ...
 * @LastEditTime: 2021-08-17 11:54:24
-->
...
export default {
  data() {
    return {
      ...
      tableData: [
        { id: 10001, name: 'Test1', nickname: 'T1', role: 'Develop', num1: '222', sex: 'Man', age: 28, address: 'info', img1: '/vxe-table/static/other/img1.gif' },
        { id: 10002, name: 'Test2', nickname: 'T2', role: 'Test', num1: '536', sex: 'Women', age: 22, address: 'danger', img1: '/vxe-table/static/other/img2.gif' },
        { id: 10003, name: 'Test3', nickname: 'T3', role: 'PM', num1: '1000', sex: 'Man', age: 32, address: 'success', img1: '/vxe-table/static/other/img1.gif' },
        { id: 10004, name: 'Test4', nickname: 'T4', role: 'Designer', num1: '424323', sex: 'Women', age: 23, address: 'danger', img1: '' },
        { id: 10005, name: 'Test5', nickname: 'T5', role: 'Develop', num1: '253', sex: 'Women', age: 30, address: 'danger', img1: '/vxe-table/static/other/img1.gif' },
        { id: 10006, name: 'Test6', nickname: 'T6', role: 'Designer', num1: '555', sex: 'Women', age: 21, address: 'danger', img1: '/vxe-table/static/other/img2.gif' },
        { id: 10007, name: 'Test7', nickname: 'T7', role: 'Test', num1: '11', sex: 'Man', age: 29, address: 'normal', img1: '' },
        { id: 10008, name: 'Test8', nickname: 'T8', role: 'Develop', num1: '998', sex: 'Man', age: 35, address: 'danger', img1: '/vxe-table/static/other/img1.gif' }
      ],
      tableToolbar: {
        custom: true,
        slots: {
      ...
      tableColumn: [
        ...
        { field: 'age', title: 'Age', width: 100 },
        {
          ...
          slots: {
            // 使用插槽模板渲染
            default: 'num1_default', // 单元格显示slot
            header: 'num1_header', // 表头slot
            footer: 'num1_footer', // 表尾slot
            filter: 'num1_filter', // 筛选
            edit: 'num1_edit' // 编辑
          }
        },
        {
          ...
          slots: {
            // 使用 JSX 渲染
            default: ({ row }) => [
              <el-tag type={row.address} v-on:click={() => this.addressClickEvent(row)}>{row.address}</el-tag>
    ...
    footerMethod({ columns, data }) {
      return [
        columns.map((column, index) => {
          if (index === 0) {
            return '平均'
          } if (['num1', 'age'].includes(column.property)) {
